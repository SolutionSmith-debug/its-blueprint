...
**Last refreshed:** 2026-06-17 (B5 doctrine cascade — excellence-roadmap v4→v5 (Track 3.4 portal-template fork-source); URS Marine mission draft→canonical; exec manifest synced (blueprint_head ad8f563, exec PR #293). See §G40.)
...
- **`~/its` is on `main` (`7510f7a`)** — publish daemon loaded + healthy.
